...
func TestParking_FindNearestSlot(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := parking.FindNearestSlot()
...
func TestParking_AddCar(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := parking.AddCar(tt.args.cr)
			if (err != nil) != tt.wantErr {
...
func TestParking_GetFilledSlots(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if gotFilledSlots := parking.GetFilledSlots(); !reflect.DeepEqual(gotFilledSlots, tt.wantFilledSlots) {
...
func TestParking_GetSlotsByCarColor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if gotSlots := parking.GetSlotsByCarColor(tt.args.carColor); !reflect.DeepEqual(gotSlots, tt.wantSlots) {
...
func TestParking_GetSlotByCarNumber(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if gotSlots := parking.GetSlotByCarNumber(tt.args.carNumber); !reflect.DeepEqual(gotSlots, tt.wantSlots) {
